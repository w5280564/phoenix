...
public class Resource<T> {
    ...
    public static <T> Resource<T> success(@Nullable T data, @Nullable String message) {
        return new Resource<>(Status.SUCCESS, data, Constants.REQUEST_SUCCESS_CODE,message);
    }

    public static <T> Resource<T> error(int code, @Nullable T data, @Nullable String message) {
