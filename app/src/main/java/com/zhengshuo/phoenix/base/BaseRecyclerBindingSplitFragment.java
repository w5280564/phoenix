 ...
 * 带分页的基类Fragment
 */
public abstract class BaseRecyclerBindingSplitFragment<VB extends ViewBinding> extends BaseBindingFragment implements BaseQuickAdapter.RequestLoadMoreListener, SwipeRefreshLayout.OnRefreshListener {
