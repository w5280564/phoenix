...
public abstract class BaseRecyclerViewSplitFragment extends BaseLazyFragment implements BaseQuickAdapter.RequestLoadMoreListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void initSwipeRefreshLayoutAndAdapter(boolean isHaveRefresh) {
        setRefreshAndLoadMore(isHaveRefresh);
    }


    protected void initSwipeRefreshLayoutAndAdapter(int emptyToastText,int emptyViewImgResource, boolean isHaveRefresh) {
        mAdapter.setEmptyView(addEmptyView(emptyToastText, emptyViewImgResource));
        setRefreshAndLoadMore(isHaveRefresh);
    }

    private void setRefreshAndLoadMore(boolean isHaveRefresh) {
