 ...
 * 带分页的基类Fragment
 */
public abstract class BaseRecyclerSplitBindingFragment<VB extends ViewBinding> extends BaseBindingFragment implements BaseQuickAdapter.RequestLoadMoreListener, SwipeRefreshLayout.OnRefreshListener {
