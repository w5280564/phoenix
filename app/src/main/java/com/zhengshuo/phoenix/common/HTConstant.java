...
public class HTConstant {
    ...
    public static final String DIR_AVATAR = Environment.getExternalStorageDirectory().toString() + "/FAST/";
    //    缩略图处理---等高宽
    ...
    //CMD ACTION
    public static final int APPLY_FRIEND = 1000;//收到好友申请
    public static final int APPLY_FRIEND_AGREE = 1001;//收到好友同意
