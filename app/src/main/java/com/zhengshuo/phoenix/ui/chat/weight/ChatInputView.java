...
import com.zhengshuo.phoenix.ui.chat.weight.emojicon.EmojiFragment;
import com.zhengshuo.phoenix.ui.chat.weight.emojicon.Emojicon;
import com.zhengshuo.phoenix.ui.chat.weight.emojicon.EmojiconDatas;
import com.zhengshuo.phoenix.ui.chat.weight.emojicon.SmileUtils;
import com.zhengshuo.phoenix.util.WidgetUtils;
...
public class ChatInputView extends LinearLayout implements View.OnClickListener {
    ...
    private ImageView iv_reference_cancel;

    private InputViewListener inputViewLisenter;
    ...
    public void initView(Activity activity, View aboveView, int[] itemNames, int[] itemIcons) {
        ...
        btn_hot = (Button) this.findViewById(R.id.btn_hot);
        ...
        //按住录音的按钮
        tv_recording = (TextView) this.findViewById(R.id.tv_recording);
        ...
        btn_send = (TextView) this.findViewById(R.id.btn_send);
        ...
        //引用区域
        ll_reference = (LinearLayout) this.findViewById(R.id.ll_reference);
        tv_reference = this.findViewById(R.id.tv_reference);
        iv_reference_cancel = this.findViewById(R.id.iv_reference_cancel);
    ...
    public void setInputViewLisenter(InputViewListener inputViewLisenter) {
    ...
    private void setListener() {
        ...
        iv_reference_cancel.setOnClickListener(this);
        ...
        tv_recording.setOnTouchListener(new OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if(inputViewLisenter != null){
                    return inputViewLisenter.onPressToSpeakBtnTouch(v, event);
                }
                return false;
            }
        });
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_send:
                ...
                break;
            case R.id.iv_reference_cancel:
                if (ll_reference.getVisibility()==VISIBLE) {
                    ll_reference.setVisibility(GONE);
                    inputViewLisenter.onCancelYinYongClick();
                }
                break;
    ...
    public LinearLayout getYinYongLayout_parent() {
        return ll_reference;
    }

    public TextView getYinYongLayout_TextView() {
        return tv_reference;
    }
    ...
    class MyItemClickListener implements ChatExtendMenu.ChatExtendMenuItemClickListener {
        ...
        public void onClick(int itemId, View view) {
            ...
            switch (itemId) {
                ...
                case 7:
                    if (inputViewLisenter != null) {
                        inputViewLisenter.onAfterReadHot();
                        btn_hot.setBackgroundResource(R.mipmap.shuangxiangchehui_yellow);
                        btn_set_mode_voice.setBackgroundResource(R.mipmap.yuyin_yellow);
                        btn_set_mode_keyboard.setBackgroundResource(R.mipmap.jianpan);
                        btn_emoticons_normal.setBackgroundResource(R.mipmap.baioqing_yellow);
                        btn_emoticons_checked.setBackgroundResource(R.mipmap.jianpan);
                        btn_more.setBackgroundResource(R.mipmap.jiahao);
                        btn_send.setBackgroundResource(R.drawable.bg_btn_send_yellow);
                    }
                    break;
                default:
                    break;
