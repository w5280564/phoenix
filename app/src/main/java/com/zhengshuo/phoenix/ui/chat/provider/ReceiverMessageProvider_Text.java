 ...
 *接收文本消息
 */
public class ReceiverMessageProvider_Text extends BaseMessageProvider_Receiver {


    @Override
    public int viewType() {
        return ChatAdapter.MESSAGE_TEXT_RECEIVED;
    }

    @Override
    public int layout() {
        return R.layout.item_chat_receiver_text;
    }
    ...
    public void convert(BaseViewHolder helper, HTMessage item, int position) {
        ...
        helper.addOnClickListener(R.id.ll_reference);
