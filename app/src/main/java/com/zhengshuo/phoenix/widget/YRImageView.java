 ...
 */
public class YRImageView extends AppCompatImageView {
    ...
    public YRImageView(Context context) {
        super(context);
        init(context, null);
    }

    public YRImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public YRImageView(Context context, AttributeSet attrs, int defStyleAttr) {
