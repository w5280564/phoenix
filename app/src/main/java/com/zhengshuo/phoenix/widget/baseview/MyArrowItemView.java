package com.zhengshuo.phoenix.widget.baseview;
...
public class MyArrowItemView extends ConstraintLayout {
    ...
    public void init(Context context, AttributeSet attrs) {
        ...
        contentColor = a.getColor(R.styleable.ArrowItemView_arrowItemContentColor, ContextCompat.getColor(getContext(), R.color.color_A1A1A1));
        if (contentColorId != -1) {
