...
/**
 * Created by ouyang on 2016/9/13.
 * 
 */
public class HTMessage implements Parcelable ,Comparable<HTMessage> {
    ...
    public static HTMessage createTextSendMessage(String chatTo, String content,ReferenceMessage mReferenceMessageObj) {
        ...
        if (mReferenceMessageObj!=null) {
            htMessage.setReferenceId(mReferenceMessageObj.getMessageId());
            htMessageTextBody.setReference(mReferenceMessageObj);
        }
...
//    }
    ...
    public HTMessage(JSONObject dataJson, Direct direct, Status status, long localTime, long time) {
        ...
        if (dataJson.containsKey("referenceId")) {
            referenceId = dataJson.getString("referenceId");
        }
...
//    }
    ...
    public String toXmppMessageBody() {
        ...
        bodyJson.put("type", SDKConstant.TYPE_MESSAGE_HT);
