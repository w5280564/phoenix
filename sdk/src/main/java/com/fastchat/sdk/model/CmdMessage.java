...
public class CmdMessage implements Parcelable {
    ...
    private CmdMessage crateCmdMessage(String chatTo) {
    ...
    public CmdMessage crateCmdMessage(String chatTo, String body) {
        CmdMessage cmdMessage = crateCmdMessage(chatTo);
    ...
    public String toXmppMessage() {
        ...
        xmppJson.put(SDKConstant.FX_MSG_KEY_TYPE, SDKConstant.TYPE_MESSAGE_CMD);
